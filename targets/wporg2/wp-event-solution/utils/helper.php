...
class Helper {
	 ...
	 */
	public static function post_data_query( $post_type, $count = null, $order = 'DESC', $term_arr = null, $taxonomy_slug = null, $post__in = null, $post_not_in = null, $tag__in = null, $orderby_meta = null, $orderby = 'post_date', $filter_with_status = null, $post_parent = '0', $post_author = '', $paged = 1 ) {
		$data = [];
		$args = [
			'post_type'        => $post_type,
			'post_status'      => 'publish',
 ...
 */
	 ...
	 */
	public static function get_attendee_by_order_id( $order_id ) {
		$all_attendee = [];
		global $wpdb;
		$table_name = $wpdb->prefix . "postmeta";
		$sql        = "SELECT post_id FROM $table_name WHERE meta_key='eventin_order_id' AND meta_value=$order_id";
		$results    = $wpdb->get_results( $sql );
	 ...
	 * @return void
	 */
	public static function eventin_ticket_widget( $single_event_id, $style = "", $class = "" ) { 
