...
= 4.0.9.7: May 20, 2025 =
* Fixed: Frontend confirmation message inconsistency, ensuring a consistent user experience when registering for events.
* Fixed: Critical error with invalid time format identified via Burp Suite, improving form validation and error handling.
* Fixed: Warning when using shortcodes with invalid event type ID, ensuring smooth shortcode execution.
* Fixed: Import/export warning when handling full event data, improving the data migration process.
* Fixed: Booking failure due to error in the Waiting List extension, ensuring successful event bookings.
* Fixed: Fatal error in the Performer widget, fixing issues in some scenarios when displaying event performers.
* Fixed: Button requiring two presses in admin area, improving the responsiveness and functionality of buttons.
* Added: "Load more" button for the attendee list, enhancing user experience by allowing users to load additional attendees seamlessly.
...
= 4.0.9.4: April 17, 2025 =
* Improved: UI enhancements for a smoother user experience.
* Added: Option to keep the venue section expanded or collapsed by default on the event page.
* Fixed: Text domain inconsistencies in translatable strings.
...
= 4.0.8.3: February 16, 2025 =
* Multiple bug fixes.

= 4.0.8.2: February 15, 2025 =
* Multiple bug fixes.
...
= 4.0.7.3: January 08, 2025 =
* Added: Security fixes.

= 4.0.7.2: December 31, 2024 =
* Added: Security patch.

= 4.0.7.1: December 30, 2024 =
* New Feature: Introducing Additional fields in booking emails.
* Fixed: Report section.
* Fixed: Event-wise Attendee list and export feature.
...
* Added: Security patch.
* Revamped: Offers calculation process during ticket purchasing.
* Fixed: Issues in the event checkout process.
* Fixed: Discount Coupons extension bugs.
* Fixed: WooCommerce Integration extension compatibility issues.
* Fixed: Conflict with the Divi theme in WooCommerce Integration.
* Fixed: Bugs in the Offline Payments extension.
* Fixed: WooCommerce checkout process errors.
* Fixed: Minor UI Fixes in Invoice extensions.
* Fixed: Multiple bug fixes to improve plugin stability.
* Improved: General UI for better usability.

= 4.0.5.2: November 12, 2024 =
* Fixed: Issue with event search functionality returning incorrect results.
* Fixed: Blank date issue in frontend event submissions.
...
= 4.0.4.6: October 5, 2024 =
* Added: Security Update.

= 4.0.4.5: September 11, 2024 =
* Fixed: Repeat Event issue - reported by @emeeder.
* Fixed: Event date issue on calendar view - reported by @lpint.

= 4.0.4.4: September 7, 2024 =
* Fixed: Compatibility issues with third-party plugins including Folder Plugin and Kubio Builder.
* Added: Security Update.
* UI improvements.

= 4.0.4.3: August 26, 2024 =
* UI improvements.

= 4.0.4.2: August 13, 2024 =
* Fixed: translation issue.

= 4.0.4.1: August 5, 2024 =
* Added: Option to set date default format on frontend Events.
* UI Improvements.

= 4.0.4.0: August 1, 2024 =
* Added: Security Update.
...
= 4.0.3.2: July 19, 2024 =
* bug fixes.

= 4.0.3.1: July 17, 2024 =
* Multiple bug fixes.

= 4.0.3.0: July 15, 2024 =
